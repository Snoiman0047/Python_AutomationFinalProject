...
class CalculatorFlows:
    ...
    def number_detection(num):
        if num == 1: UI_actions.click(base.calc_page.BTN_ONE)
        elif num == 2: UI_actions.click(base.calc_page.BTN_TWO)
        elif num == 3: UI_actions.click(base.calc_page.BTN_THREE)
        elif num == 4: UI_actions.click(base.calc_page.BTN_FOUR)
        elif num == 5: UI_actions.click(base.calc_page.BTN_FIVE)
        elif num == 6: UI_actions.click(base.calc_page.BTN_SIX)
        elif num == 7: UI_actions.click(base.calc_page.BTN_SEVEN)
        elif num == 8: UI_actions.click(base.calc_page.BTN_EIGHT)
        elif num == 9: UI_actions.click(base.calc_page.BTN_NINE)
        elif num == 0: UI_actions.click(base.calc_page.BTN_ZERO)
    ...
    def char_detection(ch):
        if ch == '+': UI_actions.click(base.calc_page.BTN_PLUS)
        elif ch == '-': UI_actions.click(base.calc_page.BTN_MINUS)
        elif ch == '/': UI_actions.click(base.calc_page.BTN_DIVIDE)
        elif ch == '*': UI_actions.click(base.calc_page.BTN_MULTIPLY)
        elif ch == '=': UI_actions.click(base.calc_page.BTN_EQUALS)
        else: raise Exception('An unexpected error occurred.')
