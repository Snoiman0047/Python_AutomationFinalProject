...
class Test_APIJSONServer:
    ...
    def test_01_post(self):
        ...
        Verifications.verify_equals(base.status_code, 201, "Status code is different")
    ...
    def test_02_patch(self):
        ...
        Verifications.verify_equals(base.status_code, 200, "Status code is different")
